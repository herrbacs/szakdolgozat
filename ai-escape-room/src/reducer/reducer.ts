...
import { exit, addItemToInventory, destroyItemFromInventory, handleMove, loadLevel, selectItemFromInventory, unselectItemFromInventory, toggleInventory, toggleObjetInspecting } from "./reducerController"
